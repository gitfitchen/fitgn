...
│   ├── page.tsx            # Home route (/) – the FitGN Rail landing page
...
### Adding Routes
- Create new routes under `src/app/<segment>/page.tsx` (App Router convention)
...
The current home page uses semantic sections with IDs for anchor navigation:
- `#hero` – Main headline and CTA buttons
- `#problem` – Problem statement
- `#solution` – Features overview
- `#pilot` – Email signup form

When adding new sections, follow this pattern for consistency.
